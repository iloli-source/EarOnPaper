...
| 6. エンジン開発 | **実装済み** | [Pitchsieve](spike/ear-pipeline/)（pytest 1165件・AIの耳100点。五線譜/TAB PDF・MIDI・簡譜/リード/度数/移動ド・GP5・音質診断・ドラム譜・移調/簡略化ほか多数をCLIから出力。**実装機能の実採譜フロー結線を完了＝孤立0**・#109） |
| 7. デスクトップアプリ | **開発中** | [app/](app/)（Electron MVP） |
