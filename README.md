...
**絶対音感エミュレータ** — 雑音を含む日常録音から、絶対音感を持つ人のように音程成分だけを選択的に抽出して楽譜にする。**非音楽家を主眼にしつつ、音楽家も対象**（簡譜/度数/Nashville/GP5等の理論系出力を用意）。詳細: [プロダクトビジョン](docs/requirements/product-vision.md)
