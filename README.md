...
| 2. 要件定義 | **v2.2確定水準** | [機能一覧104件](docs/requirements/functional-requirements.md)・[非機能一覧45件](docs/requirements/non-functional-requirements.md)・[HTMLビューア](docs/requirements/requirements-viewer.html) |
...
| 5. ツール開発・事業判断 | 未着手 | 4ゲート通過時のみ。プロダクトコアの物語はG0'実測後に確定 |
...
- **TAB譜対応は必須要件**（弦/フレット割当・チューニング/カポ・奏法検出・MusicXML TABプロファイル・TAB品質KPI）
